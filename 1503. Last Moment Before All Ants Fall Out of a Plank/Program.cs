 ...
 *
 * Given an integer n and two integer arrays left and right, the positions of the ants moving to the left 
 * and the right, return the moment when the last ant(s) fall out of the plank.
 *
 * Example 1:
 *
...
public class Solution
{
    public int GetLastMoment(int n, int[] left, int[] right)
    {
        ...
        var rightMin = right.Length > 0 ? right.Min() : n;
